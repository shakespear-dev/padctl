...
pub const core = struct {
    ...
    pub const dynamic_bind = @import("core/dynamic_bind.zig");
    pub const dynamic_bind_chord = @import("core/dynamic_bind_chord.zig");
    pub const analog_edge = @import("core/analog_edge.zig");
